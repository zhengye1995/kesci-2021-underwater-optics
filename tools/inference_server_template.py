...
if __name__ == '__main__':
    # t = time.time()
    # config_file = 'configs/experiment/round2/cas_dcn_r250_temp.py'
    # checkpoint_file = 'work_dirs/cas_dcn_r250.pth'
    # checkpoint_file = 'work_dirs/cas_dcn_r250_temp/epoch_36.pth'
